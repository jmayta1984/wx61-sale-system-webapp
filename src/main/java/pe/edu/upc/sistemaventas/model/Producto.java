package pe.edu.upc.sistemaventas.model;
...
public class Producto {
    ...
    @NotNull(message = "Debe especificar el código")
    ...
    @NotNull(message = "Debe especificar la existencia")
    ...
    public Producto(@NotNull(message = "Debe especificar el código") @Size(min = 1, max = 50, message = "El código debe medir entre 1 y 50") String codigo) {
        this.codigo = codigo;
    }
